...
export default function HomePage({ cardType: cardTypeProp = 'normal_teal' }) {
  ...
  return (
    <div style={{ position: 'relative', width: '100%', maxWidth: 'var(--max-width)', minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      ...
      {/* Overlay oscuro + color de la tarjeta */}
      <div style={{
        position: 'fixed', inset: 0, zIndex: 0,
        background: `
          linear-gradient(180deg, rgba(7,7,14,.82) 0%, rgba(7,7,14,.55) 40%, rgba(7,7,14,.85) 100%),
      ...
      {/* Fondo oscuro base cuando imagen no carga */}
      <div style={{ position: 'fixed', inset: 0, zIndex: -1, background: '#07070e' }} />

      {/* Partículas con color de la tarjeta */}
      ...
      <div style={{ position: 'relative', zIndex: 10, display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '.8rem' }}>
        <button onClick={prevCard} style={{
          ...
          background: `${nivelColor}15`,
          border: `1px solid ${nivelColor}55`,
