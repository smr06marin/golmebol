...
export default function AdminTorneoDetallePage() {
  ...
  async function fetchGoleadores() {
    ...
    // Valla menos vencida: arqueros con goals_conceded > 0
    ...
    // Opción 1: promedio goles recibidos/PJ (menor es mejor) — solo clasificados a eliminatorias
    const clasificadosIds = new Set(getClasificados().map(e => e.id))
    const op1 = listaPorteros
      .filter(p => clasificadosIds.size === 0 || true) // si no hay grupos, mostrar todos
