        ...
        return (
          <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,.9)', zIndex: 300, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '20px', overflowY: 'auto' }}
            ...
            <div onClick={e => e.stopPropagation()} style={{ width: '100%', maxWidth: '360px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '14px' }}>
              ...
              <div style={{ width: '100%', maxWidth: '340px', margin: '0 auto', position: 'relative', userSelect: 'none' }}>
      ...
      {tab === 'historial' && (
        <div style={{ padding: '16px', maxWidth: '600px', margin: '0 auto' }}>
          ...
          <button onClick={() => navigate('/jugador/historial')}
            style={{ width: '100%', background: '#07070e', border: '1px solid #00ddd0', borderRadius: '12px', padding: '12px 16px', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '14px' }}>
            <span style={{ fontSize: '1.2rem' }}>📊</span>
            <div style={{ textAlign: 'left', flex: 1 }}>
              <div style={{ fontWeight: '700', color: '#00ddd0', fontSize: '.875rem' }}>Ver historial completo</div>
              <div style={{ fontSize: '.72rem', color: '#7a9ab5', marginTop: '1px' }}>Filtros por torneo, goles, tarjetas, MVP y más</div>
            </div>
            <span style={{ color: '#00ddd0', fontSize: '1rem' }}>→</span>
          </button>

          <div style={{ fontSize: '.82rem', fontWeight: '600', color: '#202124', marginBottom: '12px' }}>
            Últimos partidos · {historial.length} jugados
          </div>
          {historial.length === 0 ? (
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
              ...
              {historial.length > 5 && (
                <button onClick={() => navigate('/jugador/historial')}
                  style={{ width: '100%', padding: '12px', background: '#f8f9fa', border: '1px solid #e8eaed', borderRadius: '12px', cursor: 'pointer', color: '#1a73e8', fontWeight: '600', fontSize: '.82rem' }}>
                  Ver todos los partidos ({historial.length}) →
                </button>
              )}
            </div>
          )}
