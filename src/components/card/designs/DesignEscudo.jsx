// Diseño de tarjeta "escudo" compartido entre DesignNivel3 (Élite) y
// DesignPremium (Leyenda). Antes este archivo estaba duplicado por completo
// en los dos (más de 350 líneas idénticas) — la única diferencia real entre
// ambos es el contorno del escudo (los paths SHAPE/INNER), así que ahora
// viven acá una sola vez y cada nivel solo pasa su propio contorno.
const ESCUDO_VARIANTS = {
  inicio: {
...
export default function DesignEscudo({ variant = 'inicio', clipId = 'activeCardClip', shape, inner }) {
  const v = ESCUDO_VARIANTS[variant] || ESCUDO_VARIANTS.inicio
