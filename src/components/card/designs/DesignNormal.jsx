...
export default function DesignNormal({ children }) {
  ...
  return (
    <svg style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', overflow: 'visible' }} viewBox="0 0 340 492" fill="none">
      <defs>
        <linearGradient id={`brdN-${uid}`} x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        <linearGradient id={`bgN-${uid}`} x1="0%" y1="0%" x2="60%" y2="100%">
      ...
      <path d="M 20 0 L 120 0 L 134 10 L 154 2 L 170 0 L 186 2 L 206 10 L 220 0 L 320 0 Q 338 0 340 17 L 340 380 Q 340 422 305 448 Q 278 466 244 476 Q 218 485 170 486 Q 122 485 96 476 Q 62 466 35 448 Q 0 422 0 380 L 0 17 Q 2 0 20 0 Z" fill={`url(#bgN-${uid})`}/>
      <path d="M 20 0 L 120 0 L 134 10 L 154 2 L 170 0 L 186 2 L 206 10 L 220 0 L 320 0 Q 338 0 340 17 L 340 380 Q 340 422 305 448 Q 278 466 244 476 Q 218 485 170 486 Q 122 485 96 476 Q 62 466 35 448 Q 0 422 0 380 L 0 17 Q 2 0 20 0 Z" fill="none" stroke={`url(#brdN-${uid})`} strokeWidth="3.5"/>
